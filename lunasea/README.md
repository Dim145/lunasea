...
- [Tracearr](https://github.com/connorgallopo/Tracearr) — unified monitoring for Plex, Jellyfin & Emby (active streams, history, users, sharing-violation detection, stream termination)
